...
>(({ className, colorCode, label, ...props }, ref) => (
  <RadioGroupPrimitive.Item
    ref={ref}
    className={`flex flex-col items-center justify-center rounded-lg border p-4 hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary ${className}`}
    {...props}
  >
    {colorCode && (
      <div
